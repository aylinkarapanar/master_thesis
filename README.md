...
Pre-generated data is available on Hugging Face https://huggingface.co/datasets/aylinsthesis/master_thesis 
...
Activate the Python virtual environment first, then run the full analysis 
by sourcing `main.R`:
...
All R scripts are sourced automatically from `main.R` and R package 
